  ...
  function validateField(field) {
    ...
    if (value !== '' && field.hasAttribute('minlength')) {
      ...
      if (value.length < minLength) {
        showFieldError(field, field.dataset.errorMinlength || 'Minimum ' + minLength + ' characters required.');
        return false;
      }
    }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '1a5e6560-c675-4b3d-a059-213f5f5a62e3',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '1a5e6560-c675-4b3d-a059-213f5f5a62e3';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '1a5e6560-c675-4b3d-a059-213f5f5a62e3';
